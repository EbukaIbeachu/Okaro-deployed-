...
class RentController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $buildings = Building::all(); // Fetch all buildings for the filter
    ...
    public function store(Request $request)
    {
        ...
        if (isset($validated['end_date'])) {
            $validated['due_day'] = Carbon::parse($validated['end_date'])->day;
        }
    ...
    public function uploadAgreement(Request $request, Rent $rent)
    {
        ...
        if ($request->hasFile('signed_agreement')) {
            ...
            if ($rent->signed_agreement_path && Storage::disk('public')->exists($rent->signed_agreement_path)) {
                Storage::disk('public')->delete($rent->signed_agreement_path);
            }
