            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        @php
                            // Format exact revenue with 2 decimal places, e.g., ₦1,250,500.00
                    ...
                    @forelse($managerAnnouncements as $ann)
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between">
                                ...
                                <form action="{{ route('buildings.announcements.destroy', ['building' => $ann->building_id, 'announcement' => $ann->id]) }}" method="POST" onsubmit="return confirm('Delete this announcement for everyone?');">
                                    @csrf
                                    @method('DELETE')
